...
.. warning:: With Uberspace 7 we can't provide versions of NodeJS newer than 22 due to the GCC compiler being too old. Please migrate to `Uberspace 8 <https://dashboard.uberspace.de/meta>`_.
