...
share the same :doc:`docroot <web-documentroot>`. Please refer to :doc:`docroot <web-documentroot>` for instructions on how to serve different content under a given domain.
